...
% ---- Persönlichen Daten:
\newcommand{\titel}{Integration von Nachhaltigkeits- indikatoren in Applikationen zur Geschäftsprozessoptimierung}
\newcommand{\titelheader}{Integration von Nachhaltigkeitsindikatoren}
\newcommand{\arbeit}{Projektarbeit 2}
\newcommand{\studiengang}{Wirtschaftsinformatik}
\newcommand{\studienjahr}{2023}
\newcommand{\autor}{Carsten Sambol}
\newcommand{\autorReverse}{Sambol, Carsten}
\newcommand{\verfassungsort}{Karlsruhe}
% \newcommand{\matrikelnr}{8007695}
\newcommand{\kurs}{WWI21B5}
% \newcommand{\bearbeitungsmonat}{Januar 2018}
\newcommand{\abgabe}{3. September 2023}
\newcommand{\bearbeitungszeitraum}{02.05.2023 - 04.09.2023}
\newcommand{\firmaName}{SAP SE}
\newcommand{\firmaStrasse}{Dietmar-Hopp-Allee 16}
\newcommand{\firmaPlz}{69190 Walldorf, Deutschland}
\newcommand{\betreuerFirma}{Steven Rösinger}
\newcommand{\betreuerDhbw}{Vita Kaplunovskaya}
